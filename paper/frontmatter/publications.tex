...
Table~\ref{Tab.publications} summarises the five publications and their relationship to the present thesis.

\begin{table}[H]
\centering
\caption{Peer-reviewed publications during Master's studies and their relationship to this thesis.}
\label{Tab.publications}
\resizebox{\textwidth}{!}{%
\begin{tabular}{@{}llcc@{}}
\toprule
Publication \& Venue \& Year \& Thesis Connection \\
\midrule
Adaptive ML for Transportation \cite{mektepbayeva2025adaptive} \& IEEE SIST \& 2025 \& LoRA adaptation, online learning \\
Deep Heterogeneity Learning \cite{sakhipov2026deep} \& Frontiers Future Transp. \& 2026 \& Seasonal decomposition, MoE \\
Federated Drift-Aware GNN \cite{sakhipov2025federated} \& Procedia Comp. Sci. \& 2025 \& Adaptive graphs, real-time latency \\
Intelligent Data-Prep Assistant \cite{yedilkhan2025intelligent} \& Vestnik KazATC \& 2025 \& Feature engineering pipeline \\
Hybrid Model Investigation \cite{begisbayev2024investigation} \& IEEE DSIT \& 2024 \& Motivation for hybrid architecture \\
\bottomrule
\end{tabular}%
}
\end{table}