...
export default function BusMarker({ bus }: Props) {
  ...
  const bg = occ > 80 ? "bg-red-500" : occ > 50 ? "bg-amber-500" : "bg-green-500";
  const badgeBg = occ > 80 ? "bg-red-100 text-red-700" : occ > 50 ? "bg-amber-100 text-amber-700" : "bg-green-100 text-green-700";

  return (
    <div className="absolute group" style={{ left: ((bus.lon - 71.25) / 0.4) * 100 + "%", top: ((51.25 - bus.lat) / 0.3) * 100 + "%", transform: "translate(-50%, -50%)" }}>
