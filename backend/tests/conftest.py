...
def seed_alerts(db, seed_stations):
    ...
    alerts = [
        AlertORM(
            severity="critical",
            title="Overcrowding at TST000",
            message="Platform capacity exceeded",
            station_id="TST000",
            family="crowding",
            what="Platform overcrowding",
            when_hint="Peak hours",
            where_hint="TST000",
            why="Ridership exceeds capacity",
            confidence=0.92,
        ...
        AlertORM(
            ...
            what="Severe weather",
            when_hint="Tonight",
            where_hint="All routes",
            why="Blizzard forecast",
            confidence=0.78,
            consequence_if_ignored="Service disruption",
