...
\pdfinfo{
   ...
   /Keywords (Passenger Flow Prediction; Graph Neural Networks; Gated Recurrent Models; Urban Transit; Deep Learning)
...
\setheaderspaces{*}{1.3\onelineskip}{*} 
\checkandfixthelayout
\setlength{\droptitle}{0pt}
\setlength{\beforechapskip}{0pt}
\setlength{\midchapskip}{0pt}
\setlength{\afterchapskip}{1.0\onelineskip}
\setbeforesecskip{0.8\onelineskip plus .2\onelineskip minus .2\onelineskip}
\setaftersecskip{0.6\onelineskip plus .2\onelineskip}
\setbeforesubsecskip{0.7\onelineskip plus .2\onelineskip minus .2\onelineskip}
\setaftersubsecskip{0.5\onelineskip plus .2\onelineskip}
%
\frenchspacing
%
\OnehalfSpacing 
...
%
\import{chapters/literature_review/}{literature_review.tex}
%
\import{chapters/methodology/}{methodology.tex}
%
