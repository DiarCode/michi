  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        <Card>
          <CardContent className="p-4">
            <p className="mb-1 text-xs text-gray-500 dark:text-gray-400">MAE</p>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <TrendArrow
                current={latest?.mape ?? 0}
                previous={previous?.mape}
              />
            </div>
          </CardContent>
        </Card>
      ...
      <div className="flex items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
        ...
        <span>Tick #{tick}</span>
        {lastTickAt && (
          <span>Last: {new Date(lastTickAt).toLocaleTimeString()}</span>
        )}
        {isStale && <span className="font-medium text-amber-500">Stale</span>}
      </div>
